...
function SortableSlideItem({
  ...
  return (
    <div
      ...
      style={style}
      onClick={onSelect}
      className={`group flex items-center gap-1.5 px-2 py-2 rounded-md cursor-pointer select-none text-sm border ${
        isSelected
              ...
              <div className="flex-1 overflow-auto p-4">
                {currentSlide.type === SlideType.CHECKPOINT ? (
                  ...
                  <div className="max-w-3xl mx-auto">
                    <div
                      className="prose prose-sm dark:prose-invert max-w-none border rounded-lg p-8 bg-card min-h-[300px]"
                      dangerouslySetInnerHTML={{
                        __html: currentSlide.content.html,
                      }}
                    />
                    {currentSlide.content.notes && (
                      <div className="mt-3 p-3 rounded bg-muted text-xs text-muted-foreground">
                  ...
                  <div className="max-w-3xl mx-auto space-y-4">
                    <div>
                      ...
                      <Textarea
                        value={currentSlide.content.html}
                        onChange={(e) =>
                          updateCurrentSlide({
                            content: {
                        ...
                        placeholder="<h2>Slide Title</h2><p>Slide content...</p>"
                        className="resize-none min-h-[240px] font-mono text-sm"
                      />
